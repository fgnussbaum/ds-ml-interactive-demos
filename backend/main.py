...
from backend.demos.regularized_regression import router as regularized_regression_router
...
app.include_router(regularized_regression_router, prefix="/api/regularized_regression")
